local Library do
    ...
    Library.Theme.Background = Color3.fromRGB(12, 12, 14)  
    ...
    do
        ...
        Library.Window = function(self, Data)
            ...
            local Items = { } do
                ...
                if IsMobile then
                    ...
                    Items["MobileToggleButton"] = Instances:Create("TextButton", {
                        ...
                        AutoButtonColor = false,
                        Name = "\0",
                        Position = UDim2New(0, Spacing, 1, -ButtonSize - Spacing),
                        AnchorPoint = Vector2New(0, 1),
                        Visible = true,
                        BorderColor3 = FromRGB(0, 0, 0),
                    ...
                    Items["MobileLockButton"] = Instances:Create("TextButton", {
                        ...
                        AutoButtonColor = false,
                        Name = "\0",
                        Position = UDim2New(0, Spacing + ButtonSize + Spacing, 1, -ButtonSize - Spacing),
                        AnchorPoint = Vector2New(0, 1),
                        Visible = true,
                        BorderColor3 = FromRGB(0, 0, 0),
                        Size = UDim2New(0, ButtonSize, 0, ButtonSize),
                    ...
                    local ToggleIcon = Instances:Create("ImageLabel", {
                        ...
                        BorderColor3 = FromRGB(0, 0, 0),
                        Name = "\0",
                        Image = "rbxassetid://130510492706892", -- 关闭图标
                        BackgroundTransparency = 1,
                        AnchorPoint = Vector2New(0.5, 0.5),
                    ...
                    local LockIcon = Instances:Create("ImageLabel", {
                        ...
                        BorderColor3 = FromRGB(0, 0, 0),
                        Name = "\0",
                        Image = "rbxassetid://122669828593160", -- 锁定图标
                        BackgroundTransparency = 1,
                        AnchorPoint = Vector2New(0.5, 0.5),
                        Position = UDim2New(0.5, 0, 0.5, 0),
                        ZIndex = 127,
                    ...
                    Items["MobileLockButton"]:Connect("InputBegan", function(Input)
                        if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                            ...
                            if Window.Draggable then
                                LockIcon.Image = "rbxassetid://122669828593160"  -- 解锁图标
                            else
                                LockIcon.Image = "rbxassetid://105847917586667"  -- 锁定图标（示例，可自行替换）
                            end
                        end
                    end)
                end
            ...
            if IsMobile then
                -- 已经有按钮控制打开/关闭，所以不需要浮动按钮了
                -- 但为了兼容，保留原有逻辑但禁用原有浮动按钮
                -- Items["FloatingButton"] 不再创建
            end
        ...
        Library.Page = function(self, Data)
            ...
            local Items = { } do
                ...
                -- 图标：使用普通 ImageLabel，不使用 UIGradient，颜色跟随 Accent
                Items["Icon"] = Instances:Create("ImageLabel", {
                    Parent = Items["Inactive"].Instance,
                    Name = "\0",
        ...
        Library.Sections.Toggle = function(self, Data)
            ...
            function Toggle:Set(Value)
                ...
                if Toggle.Value then
                    -- 开启：滑块移到右侧，背景色变 Accent
                    Items["Knob"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position = UDim2New(1, -18, 0.5, -8)})
                    ...
                    -- 关闭：滑块移回左侧，背景色变 Element
                    Items["Knob"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position = UDim2New(0, 2, 0.5, -8)})
        ...
        Library.Sections.Keybind = function(self, Data)
            ...
            function Keybind:RefreshPosition(Bool)
                if Bool then
                    ...
                    Items["EnableToggle"]:Tween(TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2New(1, -10, 0, 0)})
                else
                    Items["Text"].Instance.Position = UDim2New(0, 30, 0, 5)
                    Items["SubElements"].Instance.Position = UDim2New(0, 30, 0, 30)
                    Items["Modes"].Instance.Position = UDim2New(1, 30, 0, 0)
                    Items["EnableToggle"].Instance.Position = UDim2New(1, 20, 0, 0)
                end
            end
            ...
            function Keybind:Press(Bool)
                if not Keybind.Enabled then return end  -- 如果禁用，不触发
            ...
            local function UpdateToggleUI()
                if Keybind.Enabled then
                    Items["ToggleKnob"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position = UDim2New(1, -18, 0.5, -8)})
                    ...
                    Items["ToggleKnob"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position = UDim2New(0, 2, 0.5, -8)})
            ...
            Library:Connect(UserInputService.InputBegan, function(Input)
                ...
                if not Keybind.Enabled then return end  -- 禁用时不处理
            ...
            Library.SetFlags[Keybind.Flag] = function(Value)
                if type(Value) == "table" then
                    if Value.Key then Keybind:Set(Value.Key) end
                    if Value.Mode then Keybind:SetMode(Value.Mode) end
                    if Value.Enabled ~= nil then
                        Keybind.Enabled = Value.Enabled
                        UpdateToggleUI()
                    end
                else
                    Keybind:Set(Value)
