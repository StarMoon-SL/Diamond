local Library do
    ...
    local Themes = {
        ["Preset"] = {
            ["AccentGradient"] = Color3.fromRGB(120, 170, 255),
            ...
            ["Section Background 2"] = Color3.fromRGB(14, 14, 16),
    ...
    local Instances = { } do
        ...
        Instances.MakeDraggable = function(self)
            ...
            Library:Connect(UserInputService.InputChanged, function(Input)
                if (Input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch) and Dragging and not Library.CantDragForced then
                    Set(Input)
                end
            end)
    ...
    Library.Toggle = function(self)
        if self.CurrentWindow then
            self.CurrentWindow:SetOpen(not self.CurrentWindow.IsOpen)
        end
    end

    Library.AddDraggableButton = function(self, Text, Callback, IsDraggable)
        local Button = Instances:Create("TextButton", {
            Parent = Library.Holder.Instance,
            Text = Text,
        ...
        if IsDraggable then
            ...
            Button:Connect("InputBegan", function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                    Dragging = true
                    DragStart = Input.Position
                    StartPosition = Button.Instance.Position
                end
            end)
            ...
            Library:Connect(UserInputService.InputChanged, function(Input)
                if (Input.UserInputType == Enum.UserInputType.MouseMovement or Input.UserInputType == Enum.UserInputType.Touch) and Dragging then
                    ...
                    Button.Instance.Position = UDim2New(StartPosition.X.Scale, StartPosition.X.Offset + Delta.X, StartPosition.Y.Scale, StartPosition.Y.Offset + Delta.Y)
                end
            end)
    ...
    do 
        ...
        Library.Window = function(self, Data)
            ...
            local Window = {
                ...
                MobileButtonsSide = Data.MobileButtonsSide or "Right",
            ...
            if IsMobile then
                ...
                local LockButton = Library:AddDraggableButton("Lock", function(btn)
                    Library.CantDragForced = not Library.CantDragForced
                    btn:SetText(Library.CantDragForced and "Unlock" or "Lock")
                end, true)
                if Window.MobileButtonsSide == "Right" then
                    ...
                    LockButton.Button.Instance.Position = UDim2.new(0, 6, 0, 46)
                    LockButton.Button.Instance.AnchorPoint = Vector2.new(0, 0)
                    ToggleButton.Button.Instance.Position = UDim2.new(0, 6, 0, 6)
                    ToggleButton.Button.Instance.AnchorPoint = Vector2.new(0, 0)
                end
            end
        ...
        Library.Sections.Toggle = function(self, Data)
            ...
            function Toggle:Set(Value)
                ...
                if Toggle.Value then 
                    Items["SwitchKnob"]:Tween(TweenInfo.new(Library.Tween.Time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2New(1, -16, 0, 2)})
                    Items["SwitchTrack"]:Tween(TweenInfo.new(Library.Tween.Time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {BackgroundTransparency = 0})
                else
                    Items["SwitchKnob"]:Tween(TweenInfo.new(Library.Tween.Time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2New(0, 2, 0, 2)})
                    Items["SwitchTrack"]:Tween(TweenInfo.new(Library.Tween.Time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {BackgroundTransparency = 0.6})
                end
        ...
        Library.Sections.Button = function(self, Data)
            ...
            local Items = { } do 
                ...
                if Button.Icon and Button.Icon ~= "" then 
                    Items["Icon"] = Instances:Create("ImageLabel", {
                        Parent = Items["Text"].Instance,
                        Name = "\0",
                        ImageColor3 = FromRGB(240, 240, 240),
        ...
        Library.Sections.Keybind = function(self, Data)
            ...
            function Keybind:SetMode(Mode)
                ...
                if Data.Callback then 
                    Library:SafeCall(Data.Callback, Keybind.Toggled and Keybind.Enabled)
                end
            end
            ...
            function Keybind:Get()
                return Keybind.Key, Keybind.ModeSelected, Keybind.Toggled, Keybind.Enabled
            end
