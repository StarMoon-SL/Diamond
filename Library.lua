local Library do 
    ...
    local Themes = {
        ["Preset"] = {
            ["AccentGradient"] = FromRGB(120, 170, 255),
    ...
    Library.Repo = "https://raw.githubusercontent.com/StarMoon-SL/Diamond/main/"
    Library.Icons = { }
    Library.IconCache = { }

    function Library:LoadIconLibrary()
        local Success, Result = pcall(function()
            return game:HttpGet(Library.Repo .. "icons.json")
        end)
        if not Success then
            warn("Icon library load failed: " .. tostring(Result))
            return
        end
    ...
    function Library:GetIcon(Name, Style)
        if Library.IconCache[Name] then
            return Library.IconCache[Name]
        end
        local IconData = Library.Icons[Name]
        if not IconData then
            return nil
        end
        Style = Style or "lucide"
        local Url = IconData[Style] or IconData["lucide"]
        if not Url then
            return nil
        end
        ...
        if not Ok then
            warn("Icon fetch failed: " .. tostring(Res))
            return nil
        end
        Library.IconCache[Name] = "rbxassetid://" .. tostring(Res)
        return Library.IconCache[Name]
    end

    function Library:Icon(Name, Style)
        return Library:GetIcon(Name, Style)

    function Library:ResolveIcon(Icon)
        if type(Icon) ~= "string" then
            return Icon
        end
        if StringFind(Icon, "rbxassetid://") then
            return Icon
        end
    ...
    do 
            ...
            local Items = { } do
                ...
                if not Data.Parent2.Instance:FindFirstChild("nig") then
                    Items["PaletteIcon"] = Instances:Create("ImageLabel", {
                        ...
                        Image = Library:ResolveIcon("palette"),
                        Name = "nig",
                        BackgroundTransparency = 1,
                ...
                Items["ColorpickerWindow"] = Instances:Create("TextButton", {
                    ...
                    Size = IsMobile and UDim2New(0, 200, 0, 220) or UDim2New(0, 235, 0, 270),
                ...
                Items["Palette"] = Instances:Create("TextButton", {
                    ...
                    Size = IsMobile and UDim2New(1, -20, 1, -120) or UDim2New(1, -31, 1, -159),
                    TextSize = 14,
                    BackgroundColor3 = FromRGB(124, 163, 255)
                })
                ...
                Items["SavedColors"] = Instances:Create("ScrollingFrame", {
                    ...
                    Size = IsMobile and UDim2New(1, -10, 0, 50) or UDim2New(1, -20, 0, 69),
        ...
        Library.KeybindList = function(self, Title)
            ...
            local Items = { } do 
                ...
                Items["Icon"] = Instances:Create("ImageLabel", {
                    ...
                    AnchorPoint = Vector2New(0, 0.5),
                    Image = Library:ResolveIcon("keyboard"),
                    BackgroundTransparency = 1,
                    Position = UDim2New(0, 15, 0.5, 0),
                    ZIndex = 2,
                    BorderSizePixel = 0,
        ...
        Library.Notification = function(self, Data)
            local Items = { } do 
                ...
                Items["Icon"] = Instances:Create("ImageLabel", {
                    ...
                    Image = Library:ResolveIcon(Data.Icon),
                    BackgroundTransparency = 1,
        ...
        Library.Window = function(self, Data)
            ...
            local Items = { } do
                ...
                Items["SettingsIcon"] = Instances:Create("ImageLabel", {
                    ...
                    AnchorPoint = Vector2New(0.5, 0.5),
                    Image = Library:ResolveIcon("settings"),
                    BackgroundTransparency = 1,
                    Position = UDim2New(0.5, 0, 0.5, 0),
                    ZIndex = 3,
                    BorderSizePixel = 0,
        ...
        Library.Pages.GlobalChat = function(self, Side)
            ...
            local Items = { } do 
                ...
                Items["SendIcon"] = Instances:Create("ImageLabel", {
                    ...
                    AnchorPoint = Vector2New(0.5, 0.5),
                    Image = Library:ResolveIcon("send"),
                    BackgroundTransparency = 1,
                    ZIndex = 3,
                    Position = UDim2New(0.5, 0, 0.5, 0),
        ...
        Library.Sections.Toggle = function(self, Data)
            ...
            local Items = { } do 
                ...
                Items["SwitchTrack"] = Instances:Create("Frame", {
                    Parent = Items["Toggle"].Instance,
                    Name = "\0",
                    Size = UDim2New(0, 32, 0, 18),
                    Position = UDim2New(1, -32, 0, 2),
                ...
                Instances:Create("UICorner", {
                    Parent = Items["SwitchTrack"].Instance,
                    CornerRadius = UDimNew(1, 0)
                })
                ...
                Instances:Create("UICorner", {
                    Parent = Items["SwitchKnob"].Instance,
                    CornerRadius = UDimNew(1, 0)
                })

                Items["Toggle"]:OnHover(function()
                    Items["SwitchTrack"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2New(0, 34, 0, 20)})
                    Items["SwitchKnob"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2New(0, 16, 0, 16), Position = UDim2New(0, 1, 0, 2)})
                end)

                Items["Toggle"]:OnHoverLeave(function()
                    Items["SwitchTrack"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2New(0, 32, 0, 18)})
                    Items["SwitchKnob"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2New(0, 14, 0, 14), Position = UDim2New(0, 2, 0, 2)})
                end)
            end

            Items["SwitchTrack"].Instance.Position = UDim2New(1, -32, 0, 2)
            Items["Text"].Instance.Position = UDim2New(0, 0, 0, 3)
            ...
            function Toggle:Set(Value)
                ...
                if Toggle.Value then 
                    Items["SwitchKnob"]:Tween(TweenInfo.new(Library.Tween.Time + 0.1, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Position = UDim2New(1, -16, 0, 2)})
                    Items["SwitchTrack"]:Tween(TweenInfo.new(Library.Tween.Time + 0.1, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {BackgroundTransparency = 0})
                else
                    Items["SwitchKnob"]:Tween(TweenInfo.new(Library.Tween.Time + 0.05, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Position = UDim2New(0, 2, 0, 2)})
                    Items["SwitchTrack"]:Tween(TweenInfo.new(Library.Tween.Time + 0.05, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {BackgroundTransparency = 0.6})
                end
            ...
            function Toggle:Settings(Size)
                ...
                SettingsItem = { } do 
                    ...
                    SettingsItem["SettingsIcon"] = Instances:Create("ImageLabel", {
                        ...
                        Size = UDim2New(0, 14, 0, 14),
                        AnchorPoint = Vector2New(0, 0.5),
                        Image = Library:ResolveIcon("sliders-horizontal"),
                        BackgroundTransparency = 1,
            ...
            function Toggle:RefreshPosition(Bool)
                if Bool then 
                    Items["Text"]:Tween(TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2New(0, 0, 0, 3)})
                    Items["SwitchTrack"]:Tween(TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2New(1, -32, 0, 2)})
                else
                    Items["SwitchTrack"].Instance.Position = UDim2New(1, -62, 0, 2)
                    Items["Text"].Instance.Position = UDim2New(0, 30, 0, 3)
                end 
            end
            ...
            local Items = { } do 
                ...
                if Button.Icon then 
                    Items["Icon"] = Instances:Create("ImageLabel", {
                        ...
                        Size = UDim2New(0, 18, 0, 18),
                        AnchorPoint = Vector2New(1, 0.5),
                        Image = Library:ResolveIcon(Button.Icon),
                        BackgroundTransparency = 1,
        ...
        Library.Sections.Slider = function(self, Data)
            ...
            local Items = { } do 
                ...
                Items["RealSlider"] = Instances:Create("TextButton", {
                    ...
                    Size = UDim2New(1, -40, 0, IsMobile and 14 or 7),
                    ZIndex = 2,
                    TextSize = 14,
                    BackgroundColor3 = FromRGB(27, 26, 29)
                ...
                Items["TouchArea"] = Instances:Create("TextButton", {
                    Parent = Items["RealSlider"].Instance,
                    Name = "\0",
                    Text = "",
                    AutoButtonColor = false,
                ...
                Items["Icon"] = Instances:Create("Frame", {
                    ...
                    Name = "\0",
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(0, IsMobile and 18 or 12, 0, IsMobile and 18 or 12),
                    AnchorPoint = Vector2New(0.5, 0.5),
                    BackgroundColor3 = FromRGB(255, 255, 255),
                    Position = UDim2New(1, 0, 0.5, 0),
                    ZIndex = 3,
            ...
            function Slider:Set(Value)
                ...
                if Slider.Value >= Slider.Max then 
                    Items["Icon"].Instance.Position = UDim2New(1, 0, 0.5, 0)
                else
                    Items["Icon"].Instance.Position = UDim2New(1, 0, 0.5, 0)
                end
        ...
        Library.Sections.Dropdown = function(self, Data)
            ...
            local Items = { } do 
                ...
                Items["ArrowIcon"] = Instances:Create("ImageLabel", {
                    ...
                    AnchorPoint = Vector2New(1, 0.5),
                    Image = Library:ResolveIcon("chevron-down"),
                    BackgroundTransparency = 1,
        ...
        Library.Sections.Keybind = function(self, Data)
            ...
            local KeyListItem 
                ...
                Items["EnableSwitchTrack"] = Instances:Create("Frame", {
                    Parent = Items["SubElements"].Instance,
                    Name = "\0",
                    Size = UDim2New(0, 32, 0, 18),
                    BackgroundColor3 = Library.Theme.Accent,
                ...
                Instances:Create("UICorner", {
                    Parent = Items["EnableSwitchTrack"].Instance,
                    CornerRadius = UDimNew(1, 0)
                })

                Items["EnableSwitchKnob"] = Instances:Create("Frame", {
                    Parent = Items["EnableSwitchTrack"].Instance,
                    Name = "\0",
                    Size = UDim2New(0, 14, 0, 14),
                    Position = UDim2New(0, 2, 0, 2),
                ...
                Instances:Create("UICorner", {
                    Parent = Items["EnableSwitchKnob"].Instance,
                    CornerRadius = UDimNew(1, 0)
                })

                Items["EnableSwitchTrack"]:OnHover(function()
                    Items["EnableSwitchTrack"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2New(0, 34, 0, 20)})
                    Items["EnableSwitchKnob"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2New(0, 16, 0, 16), Position = UDim2New(0, 1, 0, 2)})
                end)

                Items["EnableSwitchTrack"]:OnHoverLeave(function()
                    Items["EnableSwitchTrack"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2New(0, 32, 0, 18)})
                    Items["EnableSwitchKnob"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2New(0, 14, 0, 14), Position = UDim2New(0, 2, 0, 2)})
                end)
            ...
            function Keybind:SetEnabled(Value)
                Keybind.Enabled = Value
                if Keybind.Enabled then
                    Items["EnableSwitchKnob"]:Tween(TweenInfo.new(Library.Tween.Time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2New(1, -16, 0, 2)})
                    Items["EnableSwitchTrack"]:Tween(TweenInfo.new(Library.Tween.Time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {BackgroundTransparency = 0})
                else
                    Items["EnableSwitchKnob"]:Tween(TweenInfo.new(Library.Tween.Time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2New(0, 2, 0, 2)})
                    Items["EnableSwitchTrack"]:Tween(TweenInfo.new(Library.Tween.Time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {BackgroundTransparency = 0.6})
                end
                Update()
            end
            ...
            Library:Connect(UserInputService.InputBegan, function(Input)
                ...
                if IsMobile and Keybind.ModeSelected == "Toggle" then
            ...
            Items["EnableSwitchTrack"]:Connect("MouseButton1Down", function()
                Keybind:SetEnabled(not Keybind.Enabled)
            end)
