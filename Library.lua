local Library do
    ...
    local Themes = {
        ["Preset"] = {
            ["AccentGradient"] = FromRGB(0, 180, 255),
            ["Background 2"] = FromRGB(20, 20, 25),
            ["Background"] = FromRGB(15, 15, 20),
            ["Text"] = FromRGB(255, 255, 255),
            ["Outline"] = FromRGB(40, 40, 50),
            ["Section Top"] = FromRGB(25, 25, 30),
            ["Section Background"] = FromRGB(18, 18, 22),
            ["Section Background 2"] = FromRGB(22, 22, 27),
            ["Accent"] = FromRGB(0, 180, 255),
            ["Element"] = FromRGB(30, 30, 38)
        }
    }

    Library.Theme = TableClone(Themes["Preset"])
    Library.Theme.Background = Color3.fromRGB(12, 12, 16)
    Library.Theme.BackgroundTransparency = 0.85
    ...
    Library.CreateColorpicker = function(self, Data)
        ...
        local Items = { } do
            ...
            Items["ColorpickerWindow"] = Instances:Create("TextButton", {
                ...
                BorderColor3 = FromRGB(0, 0, 0),
                Size = UDim2New(0, 235 * scale, 0, 270 * scale),
                BorderSizePixel = 0,
            ...
            Items["Palette"] = Instances:Create("TextButton", {
                ...
                Text = "",
                AutoButtonColor = false,
                Position = UDim2New(0, 15 * scale, 0, 10 * scale),
                Size = UDim2New(1, -31 * scale, 1, -159 * scale),
                BorderSizePixel = 0,
                TextSize = 14,
                BackgroundColor3 = FromRGB(124, 163, 255)
            })
            ...
            Items["Hue"] = Instances:Create("TextButton", {
                ...
                Position = UDim2New(0, 15 * scale, 1, -131 * scale),
                Size = UDim2New(1, -31 * scale, 0, 6 * scale),
                BorderSizePixel = 0,
                TextSize = 14,
                BackgroundColor3 = FromRGB(255, 255, 255)
            })
            ...
            Items["Alpha"] = Instances:Create("TextButton", {
                ...
                AutoButtonColor = false,
                AnchorPoint = Vector2New(0, 1),
                Position = UDim2New(0, 15 * scale, 1, -107 * scale),
                Size = UDim2New(1, -31 * scale, 0, 6 * scale),
                BorderSizePixel = 0,
                TextSize = 14,
                BackgroundColor3 = FromRGB(124, 163, 255)
            ...
            Items["SavedColors"] = Instances:Create("ScrollingFrame", {
                ...
                Size = UDim2New(1, -20 * scale, 0, 69 * scale),
                Selectable = false,
                TopImage = "rbxassetid://86870199131153",
                Position = UDim2New(0, 10 * scale, 1, -30 * scale),
            ...
            Instances:Create("UIGridLayout", {
                ...
                Name = "\0",
                SortOrder = Enum.SortOrder.LayoutOrder,
                CellPadding = UDim2New(0, 10 * scale, 0, 10 * scale),
                CellSize = UDim2New(0, 25 * scale, 0, 25 * scale)
            })

            Instances:Create("UIPadding", {
                Parent = Items["SavedColors"].Instance,
                Name = "\0",
                PaddingLeft = UDimNew(0, 5 * scale),
                PaddingTop = UDimNew(0, 5 * scale),
                PaddingRight = UDimNew(0, -125 * scale),
                PaddingBottom = UDimNew(0, 5 * scale)
            })
            ...
            Items["HEXInput"] = Instances:Create("TextBox", {
                ...
                Size = UDim2New(0, 140 * scale, 0, 20 * scale),
                TextTransparency = 0.5,
                PlaceholderColor3 = FromRGB(185, 185, 185),
                Position = UDim2New(1, -8 * scale, 1, -8 * scale),
            ...
            Items["HexLabel"] = Instances:Create("TextLabel", {
                ...
                TextTransparency = 0.5,
                AnchorPoint = Vector2New(0, 1),
                Size = UDim2New(0, 40 * scale, 0, 20 * scale),
                Position = UDim2New(0, 10 * scale, 1, -8 * scale),
                BorderSizePixel = 0,
                TextSize = 14,
                BackgroundTransparency = 1,
                BackgroundColor3 = FromRGB(30, 29, 31)
    ...
    Library.Window = function(self, Data)
        ...
        local Window = {
            ...
            BackgroundImage = Data.BackgroundImage or Data.backgroundimage or nil,
            TitleIcon = Data.TitleIcon or Data.titleicon or nil,
        ...
        local Items = { } do
            local windowSize = IsMobile and UDim2New(0, 500, 0, 450) or UDim2New(0, 677, 0, 644)
            ...
            if Window.BackgroundImage then
                ...
                Items["BackgroundImage"].Instance.ImageTransparency = 0.7
            end
            ...
            Items["MainFrame"]:MakeResizeable(Vector2New(300, 200), Vector2New(9999, 9999), OriginalSizes)
            ...
            Items["MainFrame"]:Connect("InputBegan", function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                    if not Window.Draggable then return end
                    Dragging = true
            ...
            if IsMobile then
                ...
                Items["MobileToggleButton"] = Instances:Create("TextButton", {
                    Parent = Library.Holder.Instance,
                    Text = "",
                    AutoButtonColor = false,
                    Name = "\0",
                    Position = UDim2New(1, -ButtonSize - Spacing, 1, -ButtonSize - Spacing),
                    AnchorPoint = Vector2New(1, 1),
                    Visible = true,
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(0, ButtonSize, 0, ButtonSize),
                    BorderSizePixel = 0,
                    BackgroundTransparency = 0.6,
                    ZIndex = 127,
                    BackgroundColor3 = Library.Theme.Background
                })  Items["MobileToggleButton"]:AddToTheme({BackgroundColor3 = "Background"})

                Items["MobileLockButton"] = Instances:Create("TextButton", {
                    Parent = Library.Holder.Instance,
                    Text = "",
                    AutoButtonColor = false,
                    Name = "\0",
                    Position = UDim2New(1, -ButtonSize - Spacing, 1, -(ButtonSize * 2) - (Spacing * 2)),
                    AnchorPoint = Vector2New(1, 1),
                    Visible = true,
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(0, ButtonSize, 0, ButtonSize),
                    ...
                    ZIndex = 127,
                    BackgroundColor3 = Library.Theme.Background
                })  Items["MobileLockButton"]:AddToTheme({BackgroundColor3 = "Background"})

                local ToggleIcon = Instances:Create("ImageLabel", {
                    Parent = Items["MobileToggleButton"].Instance,
                    BorderColor3 = FromRGB(0, 0, 0),
                    Name = "\0",
                ...
                local LockIcon = Instances:Create("ImageLabel", {
                    Parent = Items["MobileLockButton"].Instance,
                    BorderColor3 = FromRGB(0, 0, 0),
                    Name = "\0",
                ...
                LockIcon:AddToTheme({ImageColor3 = "Text"})
                ...
                Items["MobileToggleButton"]:Connect("InputBegan", function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                        Window:SetOpen(not Window.IsOpen)
                    end
                end)

                Items["MobileLockButton"]:Connect("InputBegan", function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                        Window.Draggable = not Window.Draggable
                        if Window.Draggable then
                            LockIcon.Image = "rbxassetid://122669828593160"
                        else
                            LockIcon.Image = "rbxassetid://105847917586667"
                        end
                    end
                end)
            end
            ...
            if Window.TitleIcon then
                Items["TitleIcon"] = Instances:Create("ImageLabel", {
                    Parent = Items["MainFrame"].Instance,
                    Name = "\0",
                    ImageColor3 = FromRGB(255, 255, 255),
                ...
                Items["TitleIcon"]:AddToTheme({ImageColor3 = "Accent"})
            end
            ...
            local titleXOffset = Window.TitleIcon and 52 or 12
            Items["Title"] = Instances:Create("TextLabel", {
                Parent = Items["MainFrame"].Instance,
                Name = "\0",
                FontFace = Library.Font,
                ...
                Size = UDim2New(0, 0, 0, 15),
                BackgroundTransparency = 1,
                Position = UDim2New(0, titleXOffset, 0, 13),
                BorderSizePixel = 0,
                ZIndex = 2,
                TextSize = 16,
                BackgroundColor3 = FromRGB(255, 255, 255)
            ...
            Items["SubTitle"] = Instances:Create("TextLabel", {
                ...
                BorderSizePixel = 0,
                BackgroundTransparency = 1,
                Position = UDim2New(0, titleXOffset, 0, 30),
                BorderColor3 = FromRGB(0, 0, 0),
                ZIndex = 2,
                TextSize = 14,
                BackgroundColor3 = FromRGB(255, 255, 255)
            ...
            function Window:SetTransparency()
                ...
                if IsMobile then
                    Items["MobileToggleButton"].Instance.BackgroundTransparency = Library.Flags["BackgroundTransparency"]
                    Items["MobileLockButton"].Instance.BackgroundTransparency = Library.Flags["BackgroundTransparency"]
                end
            ...
            Settings:Toggle({
                ...
                Default = false,
                Callback = function(Value)
                    Library.Effects.Snow = Value
                    if Value then
                        Library:StartEffect("Snow")
                    else
                        Library:StopEffect("Snow")
                    end
                end
            })
            ...
            Settings:Toggle({
                ...
                Default = false,
                Callback = function(Value)
                    Library.Effects.Rain = Value
                    if Value then
                        Library:StartEffect("Rain")
                    else
                        Library:StopEffect("Rain")
                    end
                end
            })
            ...
            Settings:Toggle({
                ...
                Default = false,
                Callback = function(Value)
                    Library.Effects.Fireworks = Value
                    if Value then
                        Library:StartEffect("Fireworks")
                    else
                        Library:StopEffect("Fireworks")
                    end
                end
            })
    ...
    Library.StartEffect = function(self, EffectName)
        if EffectName == "Snow" then
            if not self.Effects.SnowParticles then
                local particleEmitter = Instance.new("ParticleEmitter")
                particleEmitter.Texture = "rbxasset://textures/particles/snowflake_main.dds"
                ...
                particleEmitter.Parent = Camera
                self.Effects.SnowParticles = particleEmitter
            else
                self.Effects.SnowParticles.Enabled = true
            end
        elseif EffectName == "Rain" then
            if not self.Effects.RainParticles then
                local particleEmitter = Instance.new("ParticleEmitter")
                particleEmitter.Texture = "rbxasset://textures/particles/raindrop_main.dds"
                ...
                particleEmitter.Enabled = true
                particleEmitter.Parent = Camera
                self.Effects.RainParticles = particleEmitter
            else
                self.Effects.RainParticles.Enabled = true
            end
        elseif EffectName == "Fireworks" then
            if not self.Effects.FireworksRunning then
                self.Effects.FireworksRunning = true
                self:Thread(function()
                    while self.Effects.FireworksRunning do
    ...
    Library.StopEffect = function(self, EffectName)
        if EffectName == "Snow" and self.Effects.SnowParticles then
            self.Effects.SnowParticles.Enabled = false
        elseif EffectName == "Rain" and self.Effects.RainParticles then
            self.Effects.RainParticles.Enabled = false
        elseif EffectName == "Fireworks" then
            self.Effects.FireworksRunning = false
        end
    end
    ...
    Library.Page = function(self, Data)
        ...
        function Page:Turn(Bool)
            ...
            if Page.Active then
                ...
                Items["Page"]:Tween(TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2New(0, 0, 0, 55)})
            end
    ...
    Library.Sections.Toggle = function(self, Data)
        ...
        function Toggle:Set(Value)
            ...
            if Toggle.Value then
                Items["Knob"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position = UDim2New(1, -20, 0.5, -9)})
                Items["Background"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Library.Theme.Accent})
            else
                Items["Knob"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position = UDim2New(0, 2, 0.5, -9)})
                Items["Background"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Library.Theme.Element})
            end
    ...
    Library.Sections.Slider = function(self, Data)
        ...
        local Items = { } do
            ...
            Items["RealSlider"] = Instances:Create("TextButton", {
                ...
                AnchorPoint = Vector2New(0, 1),
                BorderSizePixel = 0,
                Position = UDim2New(0, 20, 1, -8),
                Size = UDim2New(1, -40, 0, 8),
                ZIndex = 2,
                TextSize = 14,
                BackgroundColor3 = FromRGB(27, 26, 29)
        ...
        function Slider:RefreshPosition(Bool)
            if Bool then
                Items["RealSlider"]:Tween(TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2New(0, 20, 1, -8)})
                Items["Text"]:Tween(TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2New(0, 0, 0, 0)})
            else
                Items["RealSlider"].Instance.Position = UDim2New(0, 80, 1, -8)
    ...
    Library.Sections.Dropdown = function(self, Data)
        ...
        local Items = { } do
            ...
            Items["RealDropdown"] = Instances:Create("TextButton", {
                ...
                BorderColor3 = FromRGB(0, 0, 0),
                Text = "",
                Size = UDim2New(0, Dropdown.Size or 125, 0, 28),
                AutoButtonColor = false,
                AnchorPoint = Vector2New(1, 0.5),
                Position = UDim2New(1, 0, 0.5, 0),
                BorderSizePixel = 0,
        ...
        Items["RealDropdown"].Instance.Position = UDim2New(1, 30, 0.5, 0)
        ...
        function Dropdown:RefreshPosition(Bool)
            if Bool then
                ...
                Items["RealDropdown"]:Tween(TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2New(1, 0, 0.5, 0)})
            else
                Items["Text"].Instance.Position = UDim2New(0, 30, 0.5, 0)
                Items["RealDropdown"].Instance.Position = UDim2New(1, 30, 0.5, 0)
            end
    ...
    Library.Sections.Label = function(self, Name)
        ...
        function Label:RefreshPosition(Bool)
            if Bool then
                Items["Text"]:Tween(TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2New(0, 0, 0, 4)})
                ...
                Items["Text"].Instance.Position = UDim2New(0, 30, 0, 4)
    ...
    Library.Sections.Keybind = function(self, Data)
        ...
        local Items = { } do
            ...
            Items["EnableToggle"] = Instances:Create("TextButton", {
                Parent = Items["Label"].Instance,
                Name = "\0",
                FontFace = Library.Font,
                TextColor3 = FromRGB(0, 0, 0),
                ...
                Size = UDim2New(0, 44, 0, 22),
                AnchorPoint = Vector2New(1, 0),
                Position = UDim2New(1, -10, 0, 1),
                ZIndex = 2,
                TextSize = 14,
                BackgroundColor3 = FromRGB(255, 255, 255)
            })

            Items["ToggleBg"] = Instances:Create("Frame", {
                Parent = Items["EnableToggle"].Instance,
                Name = "\0",
                Size = UDim2New(1, 0, 1, 0),
                BorderColor3 = FromRGB(0, 0, 0),
                ZIndex = 2,
                BorderSizePixel = 0,
                BackgroundColor3 = FromRGB(80, 80, 80)
            })  Items["ToggleBg"]:AddToTheme({BackgroundColor3 = "Element"})

            Instances:Create("UICorner", {
                Parent = Items["ToggleBg"].Instance,
                Name = "\0",
                CornerRadius = UDimNew(1, 0)
            })

            Items["ToggleKnob"] = Instances:Create("Frame", {
                Parent = Items["ToggleBg"].Instance,
                Name = "\0",
                Size = UDim2New(0, 18, 0, 18),
                Position = UDim2New(0, 2, 0.5, -9),
                ...
                BorderSizePixel = 0,
                BackgroundColor3 = FromRGB(255, 255, 255)
            })  Items["ToggleKnob"]:AddToTheme({BackgroundColor3 = "Text"})

            Instances:Create("UICorner", {
                Parent = Items["ToggleKnob"].Instance,
                Name = "\0",
                CornerRadius = UDimNew(1, 0)
            })

            Items["ModePanel"] = Instances:Create("Frame", {
                Parent = Items["SubElements"].Instance,
                Name = "\0",
                Size = UDim2New(0, 110, 0, 28),
                BackgroundColor3 = FromRGB(27, 26, 29),
                BorderColor3 = FromRGB(0, 0, 0),
                ZIndex = 2,
                BorderSizePixel = 0,
                Visible = false
            })  Items["ModePanel"]:AddToTheme({BackgroundColor3 = "Element"})

            Instances:Create("UICorner", {
                Parent = Items["ModePanel"].Instance,
                Name = "\0",
                CornerRadius = UDimNew(0, 4)
            })

            local ModeToggle = Instances:Create("TextButton", {
                Parent = Items["ModePanel"].Instance,
                Name = "\0",
                FontFace = Library.Font,
                TextColor3 = FromRGB(240, 240, 240),
                ...
                AutoButtonColor = false,
                BorderColor3 = FromRGB(0, 0, 0),
                Size = UDim2New(0.33, 0, 1, 0),
                BackgroundTransparency = 0,
                Position = UDim2New(0, 0, 0, 0),
                ZIndex = 2,
                TextSize = 12,
                BackgroundColor3 = FromRGB(27, 26, 29)
            })  ModeToggle:AddToTheme({TextColor3 = "Text", BackgroundColor3 = "Element"})

            local ModeHold = Instances:Create("TextButton", {
                Parent = Items["ModePanel"].Instance,
                Name = "\0",
                FontFace = Library.Font,
                TextColor3 = FromRGB(240, 240, 240),
                ...
                Size = UDim2New(0.33, 0, 1, 0),
                BackgroundTransparency = 0,
                Position = UDim2New(0.33, 0, 0, 0),
                ZIndex = 2,
                TextSize = 12,
                BackgroundColor3 = FromRGB(27, 26, 29)
            })  ModeHold:AddToTheme({TextColor3 = "Text", BackgroundColor3 = "Element"})

            local ModeAlways = Instances:Create("TextButton", {
                Parent = Items["ModePanel"].Instance,
                Name = "\0",
                FontFace = Library.Font,
                TextColor3 = FromRGB(240, 240, 240),
                ...
                AutoButtonColor = false,
                BorderColor3 = FromRGB(0, 0, 0),
                Size = UDim2New(0.34, 0, 1, 0),
                BackgroundTransparency = 0,
                Position = UDim2New(0.66, 0, 0, 0),
                ZIndex = 2,
                TextSize = 12,
                BackgroundColor3 = FromRGB(27, 26, 29)
            })  ModeAlways:AddToTheme({TextColor3 = "Text", BackgroundColor3 = "Element"})
        end
        ...
        local Update = function()
            if KeyListItem then
                ...
                KeyListItem:SetStatus(Keybind.Toggled and Keybind.Enabled)
            end
        end
        ...
        function Keybind:RefreshPosition(Bool)
            if Bool then
                ...
                Items["SubElements"]:Tween(TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2New(0, 0, 0, 30)})
                Items["EnableToggle"]:Tween(TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2New(1, -10, 0, 1)})
            else
                Items["Text"].Instance.Position = UDim2New(0, 30, 0, 5)
                Items["SubElements"].Instance.Position = UDim2New(0, 30, 0, 30)
                Items["EnableToggle"].Instance.Position = UDim2New(1, 20, 0, 1)
            end
        end

        function Keybind:SetMode(Mode)
            Keybind.ModeSelected = Mode
            Items["ModePanel"].Instance.Visible = false
            if Mode == "Toggle" then
                ModeToggle.BackgroundColor3 = Library.Theme.Accent
                ModeToggle.TextColor3 = FromRGB(0, 0, 0)
                ModeHold.BackgroundColor3 = Library.Theme.Element
                ModeHold.TextColor3 = Library.Theme.Text
                ModeAlways.BackgroundColor3 = Library.Theme.Element
                ModeAlways.TextColor3 = Library.Theme.Text
            elseif Mode == "Hold" then
                ModeToggle.BackgroundColor3 = Library.Theme.Element
                ModeToggle.TextColor3 = Library.Theme.Text
                ModeHold.BackgroundColor3 = Library.Theme.Accent
                ModeHold.TextColor3 = FromRGB(0, 0, 0)
                ModeAlways.BackgroundColor3 = Library.Theme.Element
                ModeAlways.TextColor3 = Library.Theme.Text
            elseif Mode == "Always" then
                ...
                ModeHold.BackgroundColor3 = Library.Theme.Element
                ModeHold.TextColor3 = Library.Theme.Text
                ModeAlways.BackgroundColor3 = Library.Theme.Accent
                ModeAlways.TextColor3 = FromRGB(0, 0, 0)
            end
        ...
        function Keybind:Set(Key)
            ...
            elseif type(Key) == "table" then
                ...
                if Key.Enabled ~= nil then
                    Keybind.Enabled = Key.Enabled
                    local knobPos = Keybind.Enabled and UDim2New(1, -20, 0.5, -9) or UDim2New(0, 2, 0.5, -9)
                    local bgColor = Keybind.Enabled and Library.Theme.Accent or Library.Theme.Element
                    Items["ToggleKnob"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position = knobPos})
                    Items["ToggleBg"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = bgColor})
                end
        ...
        local function ShowModePanel()
            Items["ModePanel"].Instance.Position = UDim2New(0, Items["KeyButton"].Instance.Position.X.Offset + Items["KeyButton"].Instance.AbsoluteSize.X + 5, 0.5, -14)
            Items["ModePanel"].Instance.Size = UDim2New(0, 110, 0, 28)
            Items["ModePanel"].Instance.Visible = true
            Items["ModePanel"].Instance.Parent = Library.Holder.Instance
            Items["ModePanel"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundTransparency = 0})
        end

        local function HideModePanel()
            Items["ModePanel"]:Tween(TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundTransparency = 1})
            task.wait(0.1)
            Items["ModePanel"].Instance.Visible = false
            Items["ModePanel"].Instance.Parent = Items["SubElements"].Instance
        end
        ...
        Items["KeyButton"]:Connect("MouseButton1Click", function()
            ...
            if not selected then
                Keybind:SetMode(Keybind.ModeSelected or "Toggle")
            end
            for _, conn in modeConnections do
                conn:Disconnect()
            end
            HideModePanel()
        ...
        local function UpdateToggleUI()
            if Keybind.Enabled then
                Items["ToggleKnob"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position = UDim2New(1, -20, 0.5, -9)})
                Items["ToggleBg"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Library.Theme.Accent})
            else
                Items["ToggleKnob"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position = UDim2New(0, 2, 0.5, -9)})
                Items["ToggleBg"]:Tween(TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Library.Theme.Element})
            end
        end

        Items["EnableToggle"]:Connect("InputBegan", function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
    ...
    Library.Sections.Listbox = function(self, Data)
        ...
        function Dropdown:RefreshPosition(Bool)
            if Bool then
                Items["Background"]:Tween(TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2New(0, 0, 0, 34)})
                Items["Search"]:Tween(TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2New(0, 0, 0, 0)})
                Items["_"]:Tween(TweenInfo.new(1, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Position = UDim2New(0, 0, 0, 28)})
            else
                Items["Background"].Instance.Position = UDim2New(0, 30, 0, 34)
                Items["Search"].Instance.Position = UDim2New(0, 30, 0, 0)
                Items["_"].Instance.Position = UDim2New(0, 30, 0, 28)
            end
        end
            ...
            function OptionData:Search(Bool)
                Library:Thread(function()
                    if Bool then
                        ...
                        task.wait(0.08)
                        OptionButton:Tween(TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2New(1, 0, 0, 24)})
